...
namespace Avalonia.Themes.Neumorphism.Controls
{
    ...
    public sealed class NavigationDrawer : ContentControl
    {
        ...
        static NavigationDrawer()
        {
            ...
            LeftDrawerExpandThresholdWidthProperty.Changed.AddClassHandler<NavigationDrawer>(OnDrawerExpandThresholdWidthChanged);
            RightDrawerExpandThresholdWidthProperty.Changed.AddClassHandler<NavigationDrawer>(OnDrawerExpandThresholdWidthChanged);
        }
        ...
        private static void OnDrawerExpandThresholdWidthChanged(NavigationDrawer drawer, AvaloniaPropertyChangedEventArgs args)
        {
            drawer.UpdateDesktopExpand(drawer.Bounds.Width);
        }
