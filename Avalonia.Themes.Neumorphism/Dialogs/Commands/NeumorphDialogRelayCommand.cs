...
namespace Avalonia.Themes.Neumorphism.Dialogs.Commands
{
    /// <summary>
    ...
    /// </summary>
    public sealed class NeumorphDialogRelayCommand : ICommand
    {
        private readonly Action<object> execute;
        private readonly Func<object, bool> canExecute;
        public event EventHandler CanExecuteChanged;

        public NeumorphDialogRelayCommand(Action<object> execute, Func<object, bool> canExecute = null)
        {
